...
1. What is Node.js?
    ...
    A JavaScript runtime environment (JRE) is the environment that allows JavaScript code to be executed, providing the necessary resources like memory management, a JavaScript engine, and APIs for interacting with the system. It is needed to run JavaScript both in browsers (with Web APIs) and on servers (like with Node.js).
